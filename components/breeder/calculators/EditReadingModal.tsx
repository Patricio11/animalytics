...
import { Edit, AlertCircle, Loader2, TrendingUp, Calendar, Heart, Sparkles, Info, Beaker } from 'lucide-react';
        ...
        <div className="space-y-6 py-4 flex-1 overflow-y-auto">
          ...
          {isInBreedingWindow && (
            <div className="space-y-4 p-4 bg-green-50 dark:bg-green-950/20 border-2 border-green-200 dark:border-green-800 rounded-lg">
              ...
              <div className="flex items-start space-x-3">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    if (checked) setMarkAsLastMating(false);
                  }}
                />
                <div className="grid gap-1.5 leading-none">
                  <label
                    htmlFor="editMarkAsMating"
              ...
              <div className="flex items-start space-x-3">
                <Checkbox
                  id="editMarkAsLastMating"
                  checked={markAsLastMating}
                  onCheckedChange={(checked) => {
                    setMarkAsLastMating(checked as boolean);
                    if (checked) setMarkAsMating(false);
                  }}
                />
                <div className="grid gap-1.5 leading-none">
                  <label
                    htmlFor="editMarkAsLastMating"
                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 cursor-pointer"
                  >
