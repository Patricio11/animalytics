      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Sign in to your breeding management account</p>
          </div>
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          <div className="max-w-md">
            <h2 className="text-4xl font-bold mb-6">
              Manage Your Breeding Program Like a Pro
            </h2>
            <p className="text-xl opacity-90 mb-8">
              Join thousands of successful breeders who trust Animalytics for their operations.
              Get insights, track performance, and optimize your breeding program.
            </p>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span>Comprehensive animal profiles</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-white/20">
                  <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span>AI-powered breeding recommendations</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex h-6 w-6 items-center justify-center rounded-full bg-white/20">
                  <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 20 20">
