...
const createPuppySchema = z.object({
  ...
  petOwnerEmail: z.string().email().optional(),
  petOwnerPhone: z.string().optional(),
  ...
  try {
    ...
    const [puppy] = await db
      ...
      .values({
        ...
        petOwnerName: validatedData.petOwnerName || null,
        petOwnerEmail: validatedData.petOwnerEmail || null,
        petOwnerPhone: validatedData.petOwnerPhone || null,
