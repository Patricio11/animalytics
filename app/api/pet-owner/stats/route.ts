...
/**
 * GET /api/pet-owner/stats
 * Get pet owner statistics and activity summary
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error fetching pet owner stats:', error);
    return NextResponse.json(
      { error: 'Failed to fetch pet owner stats' },
      { status: 500 }
    );
  }
}
